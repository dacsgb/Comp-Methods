...
class NLCF():
    ...
    def fitter(self,x,K):
        f = K[0] + K[1]*np.exp(-K[2]*x)*np.sin(K[3]*x +K[4])
        return f
    ...
    def Coeff(self):
        rpt = 'Coefficient 0 = {:.3f}'.format(self.co[0]) + '\n'
        rpt += 'Coefficient 1 = {:.3f}'.format(self.co[1]) + '\n'
        rpt += 'Coefficient 2 = {:.3f}'.format(self.co[2]) + '\n'
        rpt += 'Coefficient 3 = {:.3f}'.format(self.co[3]) + '\n'
        rpt += 'Coefficient 4 = {:.3f}'.format(self.co[4]) + '\n'
        print(rpt)
